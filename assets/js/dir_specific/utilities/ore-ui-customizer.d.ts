 ...
 * @type {File | undefined}
 */
declare let zipFile: File | undefined;
/**
 * @type {(zip.Entry)[] | undefined}
 */
declare let zipFileEntries: zip.Entry[] | undefined;
/**
 * @type {zip.FS}
 */
declare let zipFs: zip.FS | undefined;
/**
 * @type {keyof typeof currentPresets}
 */
declare let currentPreset: keyof typeof currentPresets;
/**
 * @type {File}
 */
declare let currentImportedFile: File | undefined;
/**
 * @type {HTMLElement}
 */
declare let currentColorPickerTarget: HTMLElement | undefined;
/**
 ...
 */
declare function validateZipFile(): Promise<boolean>;
 ...
 */
declare function applyColorFilterToColorOverride(target: HTMLElement, filterOptions: {
    hueShift?: number;
...
declare function stringToRegexString(str: string): string;
declare function makeRegexRobustToWhitespace(regexString: string): string;
declare function refreshOreUIPreview(menuHTMLFileName?: string): Promise<void>;
declare function applyMods(): Promise<boolean>;
declare function download(): Promise<void>;
declare function downloadInNewTab(): Promise<void>;
