...
(function (OreUICustomizer) {
     ...
     */
    OreUICustomizer.format_version = "1.13.0";
    /**
     * @type {File | undefined}
     */
    ...
    function detectAndroid() {
        ...
        if (!navigator.userAgentData) {
            if (navigator.userAgent.includes("Android") && !navigator.userAgent.includes("Windows Phone"))
                return true;
        }
        return false;
    }
    OreUICustomizer.detectAndroid = detectAndroid;
    ...
    async function validateZipFile() {
        ...
        if (!OreUICustomizer.currentImportedFile)
            return false;
        try {
            if (!failed && OreUICustomizer.zipFs.entries.findIndex((entry) => entry.getFullname() === "gui" && entry.directory) === -1) {
                failed = 1;
                if (OreUICustomizer.zipFs.entries.findIndex((entry) => entry.getFullname() === "dist" && entry.directory) !== -1) {
                    // Repair the zip directory structure.
                    OreUICustomizer.zipFs.move(OreUICustomizer.zipFs.entries.find((entry) => entry.getFullname() === "dist" && entry.directory), OreUICustomizer.zipFs.addDirectory("gui")); // adding a / to the end of the string for addDirectory causes it to show "Local Disk" inside of the zip file on windows.
                    failed = 2;
        ...
        $("#download_in_new_tab_link").removeAttr("href"); */
                ...
                else if (OreUICustomizer.zipFs.entries.findIndex((entry) => entry.getFullname() === "hbui" && entry.directory) !== -1) {
                    // Repair the zip directory structure.
                    OreUICustomizer.zipFs.move(OreUICustomizer.zipFs.entries.find((entry) => entry.getFullname() === "hbui" && entry.directory), OreUICustomizer.zipFs.addDirectory("gui/dist"));
                    failed = 2;
                    $("#import_files_error").css("color", "yellow");
...
*/
    ...
    async function applyMods() {
        ...
        {
            const entryCount = OreUICustomizer.zipFs.entries.filter((v) => v.directory === void false).length;
            let entryIndex = -1;
            ...
            try {
                for (const entry of OreUICustomizer.zipFs.entries) {
                    entryIndex++;
                    const filePath = entry.getFullname();
                    if (!filePath) {
                        unmodifiedCount++;
                    }
                        ...
                        if (entry.directory !== void false) {
                            ...
                            if (failedReplaces.length > 0)
                                allFailedReplaces[filePath] = failedReplaces;
                         ...
                         */
                        let extractedSymbolNames = getExtractedSymbolNames(origData, filePath);
                        /**
        ...
        try {
            ...
            addedCount++;
            OreUICustomizer.zipFs.addBlob("gui/dist/hbui/assets/Information_icon.png", await fetch("/assets/oreui/assets/Information_icon.png").then((r) => r.blob()));
            console.log("Added gui/dist/hbui/assets/Information_icon.png");
            addedCount++;
            OreUICustomizer.zipFs.addBlob("gui/dist/hbui/assets/Readonly_icon.png", await fetch("/assets/oreui/assets/Readonly_icon.png").then((r) => r.blob()));
            console.log("Added gui/dist/hbui/assets/Readonly_icon.png");
            addedCount++;
            OreUICustomizer.zipFs.addBlob("gui/dist/hbui/assets/Nonconfigurable_icon.png", await fetch("/assets/oreui/assets/Nonconfigurable_icon.png").then((r) => r.blob()));
            ...
            addedCount++;
            OreUICustomizer.zipFs.addBlob("gui/dist/hbui/assets/disabledButton.png", await fetch("/assets/oreui/assets/disabledButton.png").then((r) => r.blob()));
...
const oreUICustomizerVersion = ${JSON.stringify(OreUICustomizer.format_version)};`);
            ...
            addedCount++;
            OreUICustomizer.zipFs.addBlob("gui/dist/hbui/oreUICustomizer8CrafterConfig.d.ts", await fetch("/assets/oreui/oreUICustomizer8CrafterConfig.d.ts").then((r) => r.blob()));
        ...
        try {
            ...
            addedCount++;
            OreUICustomizer.zipFs.addBlob("gui/dist/hbui/customOverlays.js.map", await fetch("/assets/oreui/customOverlays.js.map").then((r) => r.blob()));
            console.log("Added gui/dist/hbui/customOverlays.js.map");
            addedCount++;
            OreUICustomizer.zipFs.addBlob("gui/dist/hbui/customOverlays.d.ts", await fetch("/assets/oreui/customOverlays.d.ts").then((r) => r.blob()));
            ...
            addedCount++;
            OreUICustomizer.zipFs.addBlob("gui/dist/hbui/class_path.js.map", await fetch("/assets/oreui/class_path.js.map").then((r) => r.blob()));
            console.log("Added gui/dist/hbui/class_path.js.map");
            addedCount++;
            OreUICustomizer.zipFs.addBlob("gui/dist/hbui/class_path.d.ts", await fetch("/assets/oreui/class_path.d.ts").then((r) => r.blob()));
            ...
            addedCount++;
            OreUICustomizer.zipFs.addBlob("gui/dist/hbui/css.js.map", await fetch("/assets/oreui/css.js.map").then((r) => r.blob()));
            console.log("Added gui/dist/hbui/css.js.map");
            addedCount++;
            OreUICustomizer.zipFs.addBlob("gui/dist/hbui/css.d.ts", await fetch("/assets/oreui/css.d.ts").then((r) => r.blob()));
            ...
            addedCount++;
            OreUICustomizer.zipFs.addBlob("gui/dist/hbui/types.d.ts", await fetch("/assets/oreui/types.d.ts").then((r) => r.blob()));
