 ...
 */
let zipFileEntries: zip.Entry[] | undefined = undefined;
// /**
//  * @type {zip.BlobWriter}
//  */
 ...
 * @type {zip.FS}
 */
let zipFs: zip.FS | undefined = undefined;
/**
 * @type {keyof typeof currentPresets}
 */
let currentPreset: keyof typeof currentPresets = "none";
/**
 * @type {File}
 */
let currentImportedFile: File | undefined = undefined;

/**
 * @type {HTMLElement}
 */
let currentColorPickerTarget: HTMLElement | undefined = undefined;
 ...
 */
async function validateZipFile(): Promise<boolean> {
    /**
     * @type {0 | 1 | 2}
     */
    let failed: 0 | 1 | 2 = 0;
 ...
 */
function applyColorFilterToColorOverride(
    target: HTMLElement,
    filterOptions: {
        hueShift?: number;
