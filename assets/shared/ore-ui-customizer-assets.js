...
export function getExtractedSymbolNames(fileContents) {
    ...
    extractedSymbolNames.jsText =
        fileContents.match(new RegExp(`${extractedSymbolNames.contextHolder}\\.createElement\\(([a-zA-Z0-9_\\$]{2}),\\{type:"body",variant:"dimmer"\\}`))?.[1] ?? extractedSymbolNames.jsText;
    ...
    extractedSymbolNames.navbarButtonImageFunction =
        fileContents.match(new RegExp(`${extractedSymbolNames.contextHolder}\\.createElement\\(([a-zA-Z0-9_\\$]{2}),\\{className:"[a-zA-Z0-9_\\$]+",src:[a-zA-Z0-9_\\$]{2},imageRendering:"pixelated"`))?.[1] ??
            extractedSymbolNames.navbarButtonImageFunction;
    ...
    const replacerRegexes = {
        ...
        hardcoreModeToggleAlwaysClickable: {
            ...
            0: [
                 ...
                 * - 1.21.90.20 preview (index-fe5c0.js)
                 */
                new RegExp(`function ([a-zA-Z0-9_\\$]{2})\\(\\s*?\\{\\s*?generalData\\s*?:\\s*?e\\s*?,\\s*?isLockedTemplate\\s*?:\\s*?t\\s*?\\}\\s*?\\)\\s*?\\{\\s*?const\\s*?\\{\\s*?t\\s*?:\\s*?(?:[a-zA-Z0-9_\\$]{1})\\s*?\\}\\s*?=\\s*?([a-zA-Z0-9_\\$]{2})\\("CreateNewWorld\\.general"\\)\\s*?,\\s*?([a-zA-Z0-9_\\$]{1})\\s*?=\\s*?([a-zA-Z0-9_\\$]{2})\\(\\)\\s*?,\\s*?o\\s*?=\\s*?\\(\\s*?0\\s*?,\\s*?${extractedSymbolNames.contextHolder}\\s*?\\.\\s*?useContext\\s*?\\)\\s*?\\(\\s*?([a-zA-Z0-9_\\$]{2})\\s*?\\)\\s*?===\\s*?([a-zA-Z0-9_\\$]{2})\\.CREATE\\s*?,\\s*?i=\\s*?\\(\\s*?0\\s*?,\\s*?${extractedSymbolNames.facetHolder}\\.useSharedFacet\\s*?\\)\\s*?\\(\\s*?([a-zA-Z0-9_\\$]{2})\\s*?\\)\\s*?,\\s*?c\\s*?=\\s*?\\(\\s*?0\\s*?,\\s*?${extractedSymbolNames.facetHolder}\\.useFacetMap\\s*?\\)\\s*?\\(\\s*?\\(\\s*?\\(\\s*?e\\s*?,\\s*?t\\s*?,\\s*?(?:[a-zA-Z0-9_\\$]{1})\\s*?\\)\\s*?=>\\s*?(?:[a-zA-Z0-9_\\$]{1})\\s*?\\|\\|\\s*?t\\s*?\\|\\|\\s*?!o\\s*?\\|\\|\\s*?e\\.gameMode\\s*?!==\\s*?([a-zA-Z0-9_\\$]{2})\\.SURVIVAL\\s*?&&\\s*?e\\.gameMode\\s*?!==\\s*?([a-zA-Z0-9_\\$]{2})\\.ADVENTURE\\s*?\\)\\s*?,\\s*?\\[\\s*?o\\s*?\\]\\s*?,\\s*?\\[\\s*?e\\s*?,\\s*?t\\s*?,\\s*?i\\s*?\\]\\s*?\\)\\s*?;\\s*?return \\s*?${extractedSymbolNames.contextHolder}\\.createElement\\(\\s*?([a-zA-Z0-9_\\$]{2})\\s*?,\\s*?\\{\\s*?title\\s*?:\\s*?([a-zA-Z0-9_\\$]{1})\\("\\.hardcoreModeTitle"\\)\\s*?,\\s*?soundEffectPressed\\s*?:\\s*?"ui\\.hardcore_toggle_press"\\s*?,\\s*?disabled\\s*?:\\s*?c\\s*?,\\s*?description\\s*?:\\s*?([a-zA-Z0-9_\\$]{1})\\("\\.hardcoreModeDescription"\\)\\s*?,\\s*?value\\s*?:\\s*?\\(\\s*?0\\s*?,\\s*?${extractedSymbolNames.facetHolder}\\.useFacetMap\\s*?\\)\\s*?\\(\\s*?\\(\\s*?e\\s*?=>\\s*?e\\.isHardcore\\s*?\\)\\s*?,\\s*?\\[\\s*?\\]\\s*?,\\s*?\\[\\s*?e\\s*?\\]\\s*?\\)\\s*?,\\s*?onChange\\s*?:\\s*?\\(\\s*?0\\s*?,\\s*?${extractedSymbolNames.facetHolder}\\.useFacetCallback\\s*?\\)\\s*?\\(\\s*?\\(\\s*?e\\s*?=>\\s*?t\\s*?=>\\s*?\\{\\s*?e\\.isHardcore\\s*?=\\s*?t\\s*?,\\s*?(?:[a-zA-Z0-9_\\$]{1})\\(\\s*?t\\s*?\\?\\s*?"ui\\.hardcore_enable"\\s*?:\\s*?"ui\\.hardcore_disable"\\s*?\\)\\s*?\\}\\s*?\\)\\s*?,\\s*?\\[\\s*?(?:[a-zA-Z0-9_\\$]{1})\\s*?\\]\\s*?,\\s*?\\[\\s*?e\\s*?\\]\\s*?\\)\\s*?,\\s*?gamepad\\s*?:\\s*?\\{\\s*?index\\s*?:\\s*?4\\s*?\\}\\s*?,\\s*?imgSrc\\s*?:\\s*?([a-zA-Z0-9_\\$]{2})\\s*?,\\s*?"data-testid"\\s*?:\\s*?"hardcore-mode-toggle"\\s*?\\}\\s*?\\)\\s*?\\}`, "g"),
            ],
        },
        /**
        ...
        addMoreDefaultGameModes: {
            ...
            1: [
                 ...
                 * - 1.21.90.21 preview (index-aaad2.js)
                 */
                new RegExp(`function\\(e\\)\\{e\\[e\\.UNKNOWN=-1\\]="UNKNOWN",e\\[e\\.SURVIVAL=0\\]="SURVIVAL",e\\[e\\.CREATIVE=1\\]="CREATIVE",e\\[e\\.ADVENTURE=2\\]="ADVENTURE"(?:,e\\[e\\.DEFAULT=5\\]="DEFAULT",e\\[e\\.SPECTATOR=6\\]="SPECTATOR")\\}\\(([a-zA-Z0-9_\$]{2})\\|\\|\\(([a-zA-Z0-9_\$]{2})=\\{\\}\\)\\),`),
            ],
        },
        /**
        ...
        allowForChangingFlatWorldPreset: {
            ...
            1: [
                 ...
                 * - \> 1.21.90.21 preview (index-aaad2.js)
                 */
                new RegExp(`return ${extractedSymbolNames.contextHolder}\\.createElement\\(${extractedSymbolNames.contextHolder}\\.Fragment,null,${extractedSymbolNames.contextHolder}\\.createElement\\(${extractedSymbolNames.facetHolder}\\.Mount,\\{when:(?:[a-zA-Z0-9_\$]{1})\\},${extractedSymbolNames.contextHolder}\\.createElement\\(([a-zA-Z0-9_\$]{2}),\\{onChange:([a-zA-Z0-9_\$]{1}),value:([a-zA-Z0-9_\$]{1}),title:([a-zA-Z0-9_\$]{1})\\("\\.useFlatWorldTitle"\\),description:(?:[a-zA-Z0-9_\$]{1})\\("\\.useFlatWorldDescription"\\),disabled:([a-zA-Z0-9_\$]{1}),offNarrationText:([a-zA-Z0-9_\$]{1}),onNarrationText:([a-zA-Z0-9_\$]{1}),narrationSuffix:([a-zA-Z0-9_\$]{1})\\}\\)\\),${extractedSymbolNames.contextHolder}\\.createElement\\(${extractedSymbolNames.facetHolder}\\.Mount,\\{when:(?:[a-zA-Z0-9_\$]{1}),condition:!1\\},${extractedSymbolNames.contextHolder}\\.createElement\\(([a-zA-Z0-9_\$]{2}),\\{title:(?:[a-zA-Z0-9_\$]{1})\\("\\.useFlatWorldTitle"\\),description:(?:[a-zA-Z0-9_\$]{1})\\("\\.useFlatWorldDescription"\\),value:(?:[a-zA-Z0-9_\$]{1}),onChange:(?:[a-zA-Z0-9_\$]{1}),disabled:(?:[a-zA-Z0-9_\$]{1}),narrationSuffix:(?:[a-zA-Z0-9_\$]{1}),offNarrationText:(?:[a-zA-Z0-9_\$]{1}),onNarrationText:(?:[a-zA-Z0-9_\$]{1}),onExpandNarrationHint:([a-zA-Z0-9_\$]{1})\\},${extractedSymbolNames.contextHolder}\\.createElement\\(([a-zA-Z0-9_\$]{2}),\\{title:([a-zA-Z0-9_\$]{1})\\("\\.title"\\),customSelectionDescription:${extractedSymbolNames.contextHolder}\\.createElement\\(([a-zA-Z0-9_\$]{2}),\\{preset:([a-zA-Z0-9_\$]{1})\\}\\),options:([a-zA-Z0-9_\$]{1}),value:([a-zA-Z0-9_\$]{1}),onItemSelect:e=>([a-zA-Z0-9_\$]{1})\\(([a-zA-Z0-9_\$]{2})\\[e\\]\\),disabled:(?:[a-zA-Z0-9_\$]{1}),wrapperRole:"neutral80",indented:!0,dropdownNarrationSuffix:([a-zA-Z0-9_\$]{1})\\}\\)\\)\\)\\)`),
            ],
        },
        /**
        ...
        add8CrafterUtilitiesMainMenuButton: {
            ...
            0: [
                 ...
                 * - 1.21.90.20 preview (index-fe5c0.js)
                 */
                new RegExp(`${extractedSymbolNames.contextHolder}\\.createElement\\(${extractedSymbolNames.facetHolder}\\.Mount,\\{when:([a-zA-Z0-9_\$]{1})\\},${extractedSymbolNames.contextHolder}\\.createElement\\(${extractedSymbolNames.contextHolder}\\.Fragment,null,${extractedSymbolNames.contextHolder}\\.createElement\\(([a-zA-Z0-9_\$]{2})\\.Divider,null\\),${extractedSymbolNames.contextHolder}\\.createElement\\(([a-zA-Z0-9_\$]{2}),\\{onClick:([eo]),screenAnalyticsId:([a-zA-Z0-9_\$]{1})\\}\\)\\)\\)`),
            ],
        },
    };
