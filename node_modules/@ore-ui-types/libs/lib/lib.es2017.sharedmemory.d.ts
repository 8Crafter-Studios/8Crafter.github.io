...
/// <reference types="./lib.es2015.symbol" />
/// <reference types="./lib.es2015.symbol.wellknown" />
...
interface SharedArrayBuffer {
    ...
    // In CoHTML (Ore UI) this property is on the constructor, not the prototype.
...
interface SharedArrayBufferConstructor {
    ...
    // In CoHTML (Ore UI) this property is on the constructor, instead of the prototype.
    readonly [Symbol.species]: SharedArrayBuffer;
}
